...
async.waterfall([
    ...
    function (cb) {
        ...
        shell.cp('-r', path.join(__dirname, 'hsa_pathway_list_dm.json'), bp);
        shell.cp('-r', path.join(__dirname, 'hsa_pathway_list_signor.json'), bp);
        ...
        shell.sed('-i', 'bower_components/cba-elements/', '', buildIndexHTML);
